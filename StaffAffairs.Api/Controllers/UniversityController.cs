    ...
    public class UniversityController : ControllerBase
    {
        ...
        public async Task<IActionResult> Update(int id, [FromBody] University University)
        {
            try
            {
                ...
                await _service.UpdateAsync(University);
                return NoContent();
            }
        ...
        [HttpGet("exact/{name}")]
        public async Task<ActionResult<University>> GetExact(string name)
        {
            try
            {
                var result = await _service.GetExactUniversityAsync(name);
                return result != null ? Ok(result) : NotFound();
            }
            catch (Exception ex)
            {
        ...
        [HttpGet("search/{name}")]
        public async Task<ActionResult<IEnumerable<University>>> Search(string name)
        {
            try
            {
                ...
                var result = await _service.SearchUniversityAsync(name);
